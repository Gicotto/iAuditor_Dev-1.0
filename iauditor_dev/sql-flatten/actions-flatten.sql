...
SELECT
    ...
    TO_CHAR(TO_TIMESTAMP_TZ(RECORD_INSERTED_AT), 'YYYY-MM-DD HH24:MI:SS') AS RECORD_INSERTED_AT,
    ...
    TO_CHAR(TO_TIMESTAMP_TZ(DATA.value:due_date::string), 'YYYY-MM-DD HH24:MI:SS') AS DUE_DATE,
    ...
    TO_CHAR(TO_TIMESTAMP_TZ(DATA.value:completed_at::string), 'YYYY-MM-DD HH24:MI:SS') AS COMPLETED_AT,
