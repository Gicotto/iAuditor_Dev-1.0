...
SELECT
    ...
    TO_CHAR(TO_TIMESTAMP_TZ(DATA.value:date_completed::string), 'YYYY-MM-DD HH24:MI:SS') AS DATE_COMPLETED,
    TO_CHAR(TO_TIMESTAMP_TZ(DATA.value:date_modified::string), 'YYYY-MM-DD HH24:MI:SS') AS DATE_MODIFIED,
    ...
    TO_CHAR(TO_TIMESTAMP_TZ(DATA.value:date_started::string), 'YYYY-MM-DD HH24:MI:SS') AS DATE_STARTED,
    TO_CHAR(TO_TIMESTAMP_TZ(DATA.value:conducted_on::string), 'YYYY-MM-DD HH24:MI:SS') AS CONDUCTED_ON,
